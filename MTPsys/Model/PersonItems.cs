...
namespace MTPsys.Model
{
    ...
    class PersonItems
    {
        ...
        public PersonItems(string test_id, object person_id, object person_name, object sex, object company_name, object list_name, int subject_id, object subject_name, object score)
        {
